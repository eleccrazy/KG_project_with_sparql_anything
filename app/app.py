...
def artist_details():
    ...
    artist_details = None
    # Here we can query the wikidata endpoint to get the artist details based on the wiki_qid
    ...
    return render_template("artist_details.html", artist=artist_details, artworks=artworks, total_artworks=len(artworks))
